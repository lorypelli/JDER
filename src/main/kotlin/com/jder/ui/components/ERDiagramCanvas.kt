...
fun ERDiagramCanvas(
  ...
  var draggedAttributeInfo by remember {
              ...
              .pointerInput(state.diagram.entities.size, state.diagram.relationships.size) {
                detectTapGestures(
                    ...
                    onLongPress = { offset ->
                      ...
                      val clickedRelationship =
                          if (clickedEntity == null) {
                            state.diagram.relationships.find {
                              isPointInDiamond(adjusted, it.x, it.y, it.width, it.height)
                            }
                          } else null
                      val clickedNote =
                          if (clickedEntity == null && clickedRelationship == null) {
                    ...
                    onDrag = { change, dragAmount ->
                      ...
                      if (isDragging)
                          handleDrag(
                              state,
                              dragAmount,
                              draggedAttributeInfo.first,
                              draggedAttributeInfo.second,
                              draggedAttributeInfo.third,
                          )
                    },
                    onDragEnd = {
